<template>
      ...
      >
        <div class="lesson-text-block">
          <div class="lesson-paras">
            <h2 id="russianPhrase">Она любит покупать продукты в магазине</h2>
      ...
      <div class="lesson-page-body lpb2">
        <div class="control-bar-block">
          ...
          <div class="audio-control">
            ...
            <a href="javascript:void(0);" @click="pauseResume">
              <img
  ...
  <audio src="" style="display: none" ref="audio"></audio>
</template>
...
import RussianSong from "../components/sounds/russianPhrase.mp3";
import EnglishSong from "../components/sounds/EnglishPhrase.mp3";
...
onMounted(() => {
  ...
  setTimeout(() => {
    ...
    playSound(EnglishSong);
  }, 10000);

  // if (showEnglishPhras.value == false) {
  // playSound(RussianSong);
  // } else {
  //   playSound(EnglishSong);
  // }
